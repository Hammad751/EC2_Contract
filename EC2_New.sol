...
////////////////////////// Auction Variables    ///////////////////////////////////
    ...
    uint256 setSlot = 190;
    uint256 startingPrice = 20 ether ;
    uint256 startTime;
...
/////////////////////////////////////////////////////////////
    ...
    // uint256 public MinitngPrice=1000000000000000; // 0.001
    // uint256 public MaxLimitPerTransaction = 3;


    uint256[2222] private maleCollection;     
    uint256[2222] private femaleCollection;    
    uint256[2222] private eliteCollection; 
    ...
    constructor(IERC20 _token, address InitialAddress) ERC721("EC_2", "EC2")
    {
        Token = _token;
      setCollection();  
      InitMinting(InitialAddress);
      collectionWallet = msg.sender;
    }
        // Initial Minting
    ...
    function getPrice(uint256 _count) public view returns (uint256)
    {
        ...
        uint256 increament;
        uint256 Price;
        uint256 timeElapsed = (block.timestamp.sub(startTime)).div(priceIncrementTime) ;
    ...
    function englishAuction(uint256 _count)
    public
    {
  ...
  ///////////////////////////////   Admin   ////////////////////////
    function startPreSale(uint256 _epochTime) public onlyOwner{
...
https://testnet.bscscan.com/address/0xe201bd1434057cafcb15e6aea3352e136e98afaa#code


// ["0x5d4E5521D240b96b4b23220be3fb2FbD05d2F119","0x440E67A54a406B16b50a2E7F110EF265e23c0eb4","0x93142F96b3EFa2C81CdF31b38e23ACF59E6D494e","0xDD4F9F4BCE03cdB81df65b64eFA1B064E118dAc3","0xD1076239F3cC60A15c021B8C6a3bA610EE16828b","0x976d06Ef41Cbb9D8a84058c3F3F139D6B684A9Cd","0xb243149940b2de3aA3F9f4436cC5218cF27CEe34","0x26A8690Cb97dE91A98E9c5cc3904A7f9019A645b","0xAeC050Ee5f8b020C45dD0770e1af6CEe271bB93F","0x4273A96728E0cd497589fb32C1B47b4FCB9b77A0"]
